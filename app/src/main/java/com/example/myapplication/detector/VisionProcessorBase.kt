...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
    ...
    private fun requestDetectInImage(image: InputImage, graphicOverlay: GraphicOverlay, originalCameraImage: Bitmap?, shouldShowFps: Boolean, frameStartMs: Long): Task<T> {
